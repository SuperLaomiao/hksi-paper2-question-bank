...
export const materials = [
  ...
  {
    title: "HKSI Paper 2 Sample Practice Test (Chinese)",
    tag: "40題官方樣題",
    url: "https://www.hksi.org/media/5711/p2-sample-practice-test-chi.pdf",
    note: "2023 年官方中文樣題 PDF，共 40 題；HKSI 明確說明並非實際考題。"
  },
  {
    title: "HKSI Paper 2 Past Q&A 2006",
    tag: "舊真題",
    url: "https://www.hksi.org/media/1188/paper2_eng_v2.pdf",
...
function buildConceptQuestions() {
  return chapters.flatMap((chapter) =>
    generatedConcepts[chapter.id].map((concept, index) => {
      ...
      return {
        ...
        stem: `就「${concept.topic}」而言，下列哪一項最準確？`,
        options,
        answer,
...
function researchQuestion(id, chapter, topic, stem, options, answer, explanation, source) {
  return { id, chapter, topic, difficulty: "真題考點", stem, options, answer, explanation, source };
}

const source2006 = "HKSI 2006 官方舊題考點（按現行手冊改寫）";
const source2023 = "HKSI 2023 官方樣題考點（重新設計）";
...
const researchQuestions = [
  researchQuestion(
    ...
    1,
    "註冊機構與持牌法團",
    "銀行甲以認可財務機構身分進行受規管活動。它與一般持牌法團的主要監管差別是什麼？",
    [
      "註冊機構屬認可財務機構，亦受金管局的前線監管；持牌法團則由證監會直接發牌監管。",
      "註冊機構完全不受證監會規定約束。",
      "持牌法團必須先成為銀行。",
      "兩者只是不同名稱，法律地位完全相同。"
    ],
    0,
    "註冊機構是認可財務機構，其監管安排涉及金管局與證監會；持牌法團则由證監會直接發牌。",
    `${source2023}；Paper 2 第1章`
  ),
  researchQuestion(
    "P2-C1-R002",
    1,
    "交易權與參與者資格",
    "一家公司只購得聯交所交易權，是否已可立即透過聯交所設施買賣？",
    [
      "可以，交易權本身等同第1類牌照。",
      "不可以；它仍須獲接納為交易所參與者並符合相關牌照及資格要求。",
      "可以，但只限替散戶交易。",
      "不可以，因交易權只供自然人持有。"
    ],
    1,
    "交易權是成為參與者及交易的必要元素之一，但不會自動賦予交易所參與者資格。",
    `${source2023}；Paper 2 第1及4章`
  ),
  researchQuestion(
    "P2-C1-R003",
    1,
    "維持操守標準的首要責任",
    "一家持牌法團的合規主任認為，維持全公司的適當操守標準完全是合規部責任。這個說法是否正確？",
    [
      "正確，董事及高級管理層沒有首要責任。",
      "不正確，首要責任在持牌法團高級管理層。",
      "正確，但只限第1類受規管活動。",
    ...
    1,
    "合規部提供監察和支援，但高級管理層對維持適當操守標準負首要責任。",
    `${source2023}；Paper 2 第1及3章`
  ),
  researchQuestion(
    "P2-C1-R004",
    1,
    "證監會紀律制裁對象",
    "持牌法團嚴重違反財政資源規則，負責人員亦被裁定失當。證監會可如何處理？",
    [
      "只可處分法團，不可處分個人。",
      "只可向兩者發私人勸告，不能公開譴責。",
      "可視情況分別對法團及個人作譴責、暫時吊銷、撤銷核准或罰款等處分。",
      "只能把案件交給聯交所，證監會沒有紀律權。"
    ],
    2,
    "紀律責任可同時落在持牌法團及涉事受規管人士，不限於公司實體。",
    `${source2023}；Paper 2 第1及7章`
  ),
  researchQuestion(
    "P2-C1-R005",
    1,
    "適當人選的整體評估",
    "申請人十年前曾在海外破產但已解除破產。這是否必然令其永遠不符合適當人選要求？",
    [
      "是，任何過往破產都構成永久禁止。",
      "否；證監會會考慮時間、原因、其後操守及整體財政與誠信情況。",
      "否，因海外事件完全不能被考慮。",
      "是，但只要考試合格便可自動豁免。"
    ],
    1,
    "適當人選評估是整體及持續評估，過往事件重要但不一定自動造成永久不合資格。",
    `${source2006}；Paper 2 第1章`
  ),
  researchQuestion(
    "P2-C1-R006",
    1,
    ...
    [
      "主席兼任所有風險與審計職能。",
      "分開主席與行政總裁職能、採用可靠會計審計標準並設獨立審計委員會。",
      "取消獨立審計以加快交易。",
      "只以短期盈利作管理層考核。"
    ],
    1,
    "職能分隔、獨立審計監督及高質素財務報告都是良好企業管治的重要元素。",
    `${source2023}；Paper 2 第1章`
  ),
  researchQuestion(
    "P2-C1-R007",
    1,
    "影響中介人的一般法律",
    "中介人與客戶訂立合約及僱用客戶主任時，下列哪項一般法律概念正確？",
    [
      "合約雙方須有法律行為能力，而僱員亦負有適當技能、勝任及保密責任。",
      "客戶是否有法律行為能力與合約有效性無關。",
      "僱員可任意披露客戶資料。",
      "普通法責任只適用於上市公司董事。"
    ],
    0,
    "合約能力、僱員責任及保密義務均可能影響中介人的法律責任。",
    `${source2006}；Paper 2 第1章`
  ),
  researchQuestion(
    "P2-C2-R008",
    ...
    2,
    "該規則針對持牌法團及其有聯繫實體；註冊機構另受適用銀行監管安排規管。",
    `${source2023}；Paper 2 第2章`
  ),
  researchQuestion(
    "P2-C2-R009",
    2,
    ...
    [
      "可按管理層偏好忽略不利項目。",
      "計算基礎須反映交易實質，而不是只看交易名稱或形式。",
      "所有項目可隨意混用交易日和交收日基準。",
      "只需計算資產，不需計算負債。"
    ],
    1,
    "財政資源計算應反映交易實質並採用一致、符合規則的基礎。",
    `${source2023}；Paper 2 第2章`
  ),
  researchQuestion(
    "P2-C2-R010",
    2,
    "資產負債表外負債",
    "某項義務沒有列在資產負債表上，計算監管資本時可否因此自動忽略？",
    [
      "可以，表外項目永遠不是負債。",
      "可以，只要核數師尚未發現。",
      "不可以；是否計入取決於財政資源規則，而非單看它是否列在資產負債表。",
      "只要客戶同意便可忽略。"
    ],
    2,
    "監管計算須按規則識別實質負債，表外並不等於可以排除。",
    `${source2023}；Paper 2 第2章`
  ),
  researchQuestion(
    "P2-C2-R011",
    2,
    "非中央結算 OTC 保證金資產",
    "持牌法團收取非中央結算 OTC 交易保證金時，下列哪項最可能不合資格？",
    [
      "現金",
      "認可海外交易所上市的合資格債務證券",
      "與該持牌法團同一集團公司發行的上市股份",
    ...
    2,
    "同集團發行的股份存在高度錯向風險，不能視作合適的獨立保證金資產。",
    `${source2023}；Paper 2 第2及6章`
  ),
  researchQuestion(
    "P2-C2-R012",
    2,
    "OTC 匯報豁免終止",
    "持牌法團不再符合 OTC 交易匯報豁免後，三個月寬限期的正確理解是什麼？",
    [
      "寬限期內所訂交易永遠無需匯報。",
      "它可在寬限期內完成匯報，但資料須涵蓋自失去豁免當日起的相關交易。",
      "只有在證監會另行提醒後才開始計算。",
      "寬限期等同永久豁免。"
    ],
    1,
    "寬限期是完成匯報的時間安排，不是把期間內交易排除在匯報範圍之外。",
    `${source2023}；Paper 2 第2章`
  ),
  researchQuestion(
    "P2-C2-R013",
    2,
    "集團內 OTC 交易匯報",
    "非豁免持牌法團在香港代表同集團公司訂立指明 OTC 交易，是否因屬集團內交易而免除匯報？",
    [
      "是，任何集團內交易都自動豁免。",
      "否；代表集團公司訂立並不自動消除該持牌法團的匯報責任。",
      "只有客戶同意才需匯報。",
      "只有交易虧損才需匯報。"
    ],
    1,
    "交易對手或客戶與持牌法團同屬一個集團，並不自動產生全面豁免。",
    `${source2023}；Paper 2 第2章`
  ),
  researchQuestion(
    "P2-C2-R014",
    2,
    "外部電子數據儲存",
    "持牌法團把受 AML 備存紀錄規定約束的資料只存放在外部雲端或數據中心，事前應注意什麼？",
    [
      "只要數據中心在香港便完全不用批准。",
      "只要使用私有雲便完全不用批准。",
      "不論公有/私有雲或境內/境外設施，僅以外部電子儲存方式保存時須依規定事先取得證監會批准。",
      "只需取得客戶口頭同意。"
    ],
    2,
    "關鍵在於法定紀錄是否只存於外部電子數據儲存提供者，而不單是伺服器位置或雲端類型。",
    `${source2023}；Paper 2 第2及3章`
  ),
  researchQuestion(
    "P2-C3-R015",
    3,
    "非面對面開戶",
    "持牌法團為海外客戶辦理網上開戶，下列哪組措施較合適？",
    [
      "取得身份文件電子副本、由可靠獨立服務核實資料，並以合規電子簽署取得客戶協議。",
      "只要求客戶把任何金額現金轉入公司帳戶。",
      "只接受社交媒體頭像作身份證明。",
      "完全省略身份核實。"
    ],
    0,
    "非面對面開戶可使用合規科技及電子簽署，但仍須完成可靠身份核實和客戶協議程序。",
    `${source2023}；Paper 2 第3章`
  ),
  researchQuestion(
    "P2-C3-R016",
    3,
    "機構專業投資者資料豁免",
    "中介人服務機構專業投資者時，下列哪項通常仍不能因專業投資者身分而省略？",
    [
      "識別及核實客戶身份",
      "評估其一般投資目標",
      "在適用豁免下建立財政狀況",
    ...
    0,
    "專業投資者豁免不等於匿名交易；客戶身份及 AML 要求仍須遵守。",
    `${source2023}；Paper 2 第3章`
  ),
  researchQuestion(
    "P2-C3-R017",
    3,
    "未獲邀約造訪的撤銷權",
    "散戶因陌生中介人的未獲邀約電話而簽訂投資協議，最可能享有哪項法定保障？",
    [
      "在法例指明期間內撤銷因該未獲邀約造訪而訂立的協議。",
      "所有投資虧損由賠償基金自動補回。",
      "中介人可在簽約後補做適合性而免除責任。",
      "協議一經簽署便永遠不能撤銷。"
    ],
    0,
    "未獲邀約造訪規定可賦予投資者在指明期間內撤銷相關協議的權利。",
    `${source2023}；Paper 2 第3及7章`
  ),
  researchQuestion(
    "P2-C3-R018",
    3,
    "最佳執行",
    "交易員遺忘客戶早上的買盤，下午才在價格轉差後執行。這最直接違反哪項操守要求？",
    [
      "及時、公平及以最佳可得條件執行客戶指令的勤勉責任。",
      "客戶款項必須存入定期存款的要求。",
      "所有交易必須成為賣空的要求。",
      "研究報告必須正面的要求。"
    ],
    0,
    "收到客戶指令後應準確記錄並及時執行，不能因內部疏忽令客戶受到不公平對待。",
    `${source2006}；Paper 2 第3章`
  ),
  researchQuestion(
    "P2-C3-R019",
    3,
    "非金錢利益及軟佣金",
    "中介人以客戶交易佣金取得第三方研究服務，什麼情況下較可能符合軟佣金要求？",
    [
      "服務直接有助投資決策或交易執行，安排已披露且佣金合理。",
      "服務只供董事私人旅遊。",
      "毋須向客戶披露任何安排。",
      "只要供應商送禮便必然合規。"
    ],
    0,
    "軟佣金利益須與投資決策或交易執行有實質關係，並受披露、最佳執行及合理性限制。",
    `${source2006}；Paper 2 第3章`
  ),
  researchQuestion(
    "P2-C3-R020",
    3,
    "客戶指令紀錄",
    "中介人收到客戶口頭交易指令时，最稳妥的处理是哪一项？",
    [
      "及時記錄指令內容、收到時間及相關帳戶資料，並按優先次序執行。",
      "只在交易出現虧損時補寫紀錄。",
      "用交易員記憶代替所有紀錄。",
      "先執行公司自營盤再處理客戶盤。"
    ],
    0,
    "時間印記和完整指令紀錄有助證明公平處理、最佳執行及處理爭議。",
    `${source2006}；Paper 2 第3章`
  ),
  researchQuestion(
    "P2-C3-R021",
    3,
    "高壓推銷證券",
    "銷售員以高壓手法及極高回報承諾迫使客戶買入證券，監管上最貼切的定性是什麼？",
    [
      "正常市場推廣",
      "高壓推銷證券活動，屬不當交易手法。",
      "只要證券是指數成份股便合規。",
    ...
    1,
    "高壓推銷和誇大回報會損害客戶作出知情決定的能力，可能影響中介人的適當人選資格。",
    `${source2023}；Paper 2 第3及7章`
  ),
  researchQuestion(
    "P2-C4-R022",
    4,
    "停牌後的交收",
    "某上市股份在成交當日稍後停牌。停牌是否通常令已成交的買賣自動撤銷？",
    [
      "是，所有已成交買賣必須逆轉。",
      "否，已成交買賣一般仍按正常結算交收安排處理，除非適用規則另有安排。",
      "是，並由投資者賠償基金承擔所有差額。",
      "只要任何客戶提出要求便自動撤銷。"
    ],
    1,
    "停牌限制其後交易，但不等於自動推翻停牌前已成立的交易。",
    `${source2006}；Paper 2 第4章`
  ),
  researchQuestion(
    "P2-C4-R023",
    4,
    "滬港通售出前端監控",
    "投資者沒有把滬股存放在執行券商帳戶，仍想透過滬港通出售。哪項安排最關鍵？",
    [
      "只要聲稱自己是專業投資者即可。",
      "在 CCASS 特別獨立戶口有足夠股份，並完成投資者識別號的取得及註冊。",
      "可以先無擔保賣空，再於一個月後補貨。",
      "只需提供香港身份證副本。"
    ],
    1,
    "特別獨立戶口安排可支援售出前端監控，同時須符合投資者識別制度要求。",
    `${source2023}；Paper 2 第4及5章`
  ),
  researchQuestion(
    "P2-C4-R024",
    4,
    "領航星交易平台交易類型",
    "下列哪類交易通常透過聯交所證券市場中央買賣盤系統作買賣盤帶動對盤？",
    [
      "符合系統規格的正常買賣盤",
      "超出最高買賣盤限額的指令",
      "碎股交易程序下的交易",
    ...
    0,
    "中央平台處理符合規格的買賣盤帶動對盤；交叉盤、碎股及超限額指令有不同處理安排。",
    `${source2023}；Paper 2 第4章`
  ),
  researchQuestion(
    "P2-C4-R025",
    4,
    "證券借貸抵押品",
    "交易所參與者從事證券借出時，抵押品應如何管理？",
    [
      "完全由商業決定，可不收任何抵押品。",
      "按市價計值收取有可確定市價、足以反映借入證券市場風險的抵押品。",
      "所有交易一律只收固定 10% 抵押品。",
      "只在借入人違約後才首次估值。"
    ],
    1,
    "證券借貸抵押品須按市價監控並足以覆蓋相關市場風險。",
    `${source2023}；Paper 2 第4及5章`
  ),
  researchQuestion(
    "P2-C4-R026",
    4,
    "競價時段價格波動機制",
    "開市前時段使用與收市競價時段相关的價格波動控制時，哪些產品可能納入？",
    [
      "只限普通股",
      "普通股及 ETF，但不包括 REIT",
      "普通股、ETF、REIT，以及槓桿及反向產品",
      "只限債券"
    ],
    2,
    "官方樣題把普通股、ETF、REIT 及槓桿/反向產品列為相關產品類別。",
    `${source2023}；Paper 2 第4章`
  ),
  researchQuestion(
    "P2-C4-R027",
    4,
    "上市規則目標",
    "下列哪項最符合聯交所《上市規則》的主要目標？",
    [
      "確保股東獲公平對待，並維持證券發行及銷售的公平有序。",
      "保證每家上市公司股價上升。",
      "替所有投資者選擇證券。",
      "取消上市公司的披露責任。"
    ],
    0,
    "上市規則著重公平對待、充分披露及公平有序的證券發行和市場。",
    `${source2006}；Paper 2 第4章`
  ),
  researchQuestion(
    "P2-C4-R028",
    4,
    "沽空研究報告與澄清公告",
    "上市發行人認為沽空機構的報告失實並已造成市場混亂，最合適的即时应对是什么？",
    [
      "永久不作回應。",
      "要求短暫停牌，以便盡快刊發適當澄清公告。",
      "直接要求證監會替公司提起私人索償。",
    ...
    1,
    "若需時間釐清可能的虛假市場，短暫停牌配合迅速、準確的澄清公告是合適方向。",
    `${source2023}；Paper 2 第4及5章`
  ),
  researchQuestion(
    "P2-C5-R029",
    5,
    "第1類牌照下的保證金融資",
    "第1類持牌法團向自己的證券交易客戶提供保證金融資，是否必然另需第8類牌照？",
    [
      "是，任何情況都必須另領第8類。",
      "不一定；第1類持牌法團可在其證券交易業務中向自己的證券客戶提供相關融資。",
      "不用，但只因所有保證金融資都不受規管。",
      "只要客戶是散戶便不用。"
    ],
    1,
    "第1類持牌法團存在與其證券交易客戶相關的牌照豁除範圍，但仍須遵守保證金融資規定。",
    `${source2023}；Paper 2 第5章`
  ),
  researchQuestion(
    "P2-C5-R030",
    5,
    "再質押前的客戶授權",
    "第8類中介人拟把客戶證券抵押品再質押予認可財務機構借款，事前最重要的文件是什麼？",
    [
      "金管局對每宗交易的批准",
      "相關客戶的有效常設授權或書面指示",
      "客戶放棄所有法律責任的聲明",
    ...
    1,
    "再質押涉及使用客戶資產，必須有有效客戶授權或書面指示，並受上限等規則限制。",
    `${source2023}；Paper 2 第5章`
  ),
  researchQuestion(
    "P2-C5-R031",
    5,
    "核准介紹代理人的文件責任",
    "核准介紹代理人只作介紹、不執行交易亦不收取客戶資產。成交單據通常应由谁发出？",
    [
      "核准介紹代理人仍須把自己當成執行經紀發出。",
      "實際執行交易並與客戶維持交易帳戶的中介人。",
      "任何一名客戶自行發出。",
      "香港結算替所有客戶發出。"
    ],
    1,
    "核准介紹代理人不執行交易，因此成交文件責任通常由實際執行及記帳的中介人承擔。",
    `${source2023}；Paper 2 第5章`
  ),
  researchQuestion(
    "P2-C5-R032",
    5,
    "客戶信貸風險控制",
    "證券交易商向客戶提供信貸時，下列哪項做法不適當？",
    [
      "設定合適信貸限額。",
      "考慮可能削弱客戶信用的已知事件。",
      "對抵押證券市值作適當扣減。",
      "把客戶以信貸購入的證券記入公司自營帳戶直至還款。"
    ],
    3,
    "客戶證券仍屬客戶資產，不應因提供信貸而記入公司自營帳戶。",
    `${source2023}；Paper 2 第5章`
  ),
  researchQuestion(
    "P2-C5-R033",
    5,
    "網上交易系統故障通知",
    "網上交易系統发生重大故障，客户暂时无法落盘。中介人最合適的做法是什麼？",
    [
      "保持沉默，避免影響公司聲譽。",
      "迅速通知受影響客戶，說明故障及可用的替代落盤渠道。",
      "刪除所有未完成指令。",
      "只在下一年度報告提及。"
    ],
    1,
    "及時通知和提供替代渠道可減少客戶損失，亦是業務延續安排的一部分。",
    `${source2006}；Paper 2 第5章`
  ),
  researchQuestion(
    "P2-C5-R034",
    5,
    "認可集體投資計劃廣告",
    "第1類持牌法團發出邀請公眾購入已獲認可集體投資計劃的廣告，哪項說法較準確？",
    [
      "即使產品已獲認可，廣告在所有情況仍必須逐份重新取得產品認可。",
      "產品已獲認可可影響廣告的事前認可要求，但中介人仍須遵守適用廣告及操守規定。",
      "只要是廣告便完全不受 SFO 規管。",
      "持有多一類牌照便可免除所有廣告規定。"
    ],
    1,
    "已認可產品與未認可產品的廣告認可安排不同，但失實陳述和操守要求仍然適用。",
    `${source2023}；Paper 2 第5章`
  ),
  researchQuestion(
    "P2-C5-R035",
    5,
    "衍生產品辨識",
    "投資者透過自己全資擁有的私人公司間接持有上市股份，這項權益本身是否等同持有衍生產品？",
    [
      "是，任何間接持股都必然是衍生產品。",
      "否；單純間接持股不同於期權或以該股份為相關資產的差價合約。",
      "是，因私人公司只能持有衍生產品。",
      "是否為衍生產品只看投資者國籍。"
    ],
    1,
    "期權及差價合約屬衍生產品；透過私人公司持有股份本身並不因此變成衍生產品。",
    `${source2023}；Paper 2 第5章`
  ),
  researchQuestion(
    "P2-C6-R036",
    6,
    "期權估值頻率",
    "期權中介人只在合約到期日計算信貸及市場風險，是否足夠？",
    [
      "足夠，期權到期前沒有價格風險。",
      "不足；估值及定價應按市價計值，風險估值應至少每日進行。",
      "足夠，只要客戶是專業投資者。",
      "不足，因期權每日必須以固定歷史成本計值。"
    ],
    1,
    "每日按市價估值能及早反映市場和信貸風險，不能等到到期才處理。",
    `${source2023}；Paper 2 第6章`
  ),
  researchQuestion(
    "P2-C6-R037",
    6,
    ...
    [
      "只要交易員覺得方便。",
      "相關淨額結算安排在法律及操作上可接受並可執行。",
      "任何不同客戶的風險都可任意互相抵銷。",
      "只有合約到期後才可。"
    ],
    1,
    "淨額計算必須建立在有效及可執行的安排上，不能只是內部假設。",
    `${source2023}；Paper 2 第6章`
  ),
  researchQuestion(
    "P2-C6-R038",
    6,
    "期權按市價計值系統",
    "期權結算所採用按市價計值的主要風險管理效果是什麼？",
    [
      "允許參與者長期累積未確認虧損。",
      "透過定期重估及追收按金，避免市場持倉虧損隨時間累積。",
      "取消所有期權金。",
      "保證每名客戶都能獲利。"
    ],
    1,
    "按市價計值把現時風險及時反映在按金要求中，減少虧損累積。",
    `${source2023}；Paper 2 第6章`
  ),
  researchQuestion(
    "P2-C6-R039",
    6,
    "買入期權的期權金",
    "客戶買入交易所期權後，參與者對期權金應如何處理？",
    [
      "由經紀按客戶財政狀況自行打折。",
      "在成交當日通知客戶應付期權金，並迅速以現金收取。",
      "待合約到期才首次通知。",
      "期權買方永遠毋須支付期權金。"
    ],
    1,
    "期權金是買方取得權利的成本，成交後應及時通知及收取。",
    `${source2023}；Paper 2 第6章`
  ),
  researchQuestion(
    "P2-C6-R040",
    6,
    "OTC 信貸風險職能獨立性",
    "從事 OTC 衍生工具的中介人應由誰負責日常信貸風險管理？",
    [
      "由產生交易收入的前線交易員全權兼任。",
      "設置獨立於承擔風險業務的信貸風險管理職能。",
      "只交給客戶自行管理。",
      "只在發生違約後由核數師處理。"
    ],
    1,
    "獨立性可避免收入目標凌駕交易對手限額、估值及風險判斷。",
    `${source2023}；Paper 2 第6章`
  ),
  researchQuestion(
    "P2-C6-R041",
    6,
    "直接買賣股票期權的資格",
    "第1類持牌法團想直接替客戶在股票期權市場交易，哪組條件最关键？",
    [
      "只要持有第1類牌照即可。",
      "成為期權交易所參與者，透過 HKATS 交易，並具 OCH 結算參與者資格或與全面結算參與者訂立安排。",
      "只要是 CCASS 投資者戶口持有人。",
      "只要客戶簽署風險披露便可繞過交易所資格。"
    ],
    1,
    "直接交易資格、交易系統連接及結算安排缺一不可。",
    `${source2023}；Paper 2 第6章`
  ),
  researchQuestion(
    "P2-C6-R042",
    6,
    "非結算期權參與者",
    "期權交易所參與者本身不是 OCH 結算參與者，應如何安排結算？",
    [
      "不需要結算。",
      "透過合資格的直接或全面結算參與者安排其期權交易結算。",
      "由客戶自行向上市公司交收。",
      "只可在合約到期後申請臨時結算。"
    ],
    1,
    "非結算參與者須預先建立合資格結算安排，不能在成交後才決定是否結算。",
    `${source2006}；Paper 2 第6章`
  ),
  researchQuestion(
    "P2-C7-R043",
    7,
    "市場操縱的地域範圍",
    "下列哪個情況最可能完全不屬香港市場失當規定的地域連繫範圍？",
    [
      "人在香港，操縱香港市場。",
      "人在海外，操縱香港市場。",
      "人在香港，從事涉及海外市場的操縱行為。",
      "人在海外，行為及受影響市場均完全在海外且與香港無關。"
    ],
    3,
    "SFO 的地域連繫可涵蓋香港境內行為或影響香港市場的境外行為；完全境外且無香港連繫則不同。",
    `${source2023}；Paper 2 第7章`
  ),
  researchQuestion(
    "P2-C7-R044",
    7,
    "內幕交易關連人士",
    "就上市法團內幕交易條文而言，谁可能因其职位或持股成为关连人士？",
    [
      "只有董事局主席。",
      "只有持股超過 50% 的股東。",
      "董事、高級/非執行董事、達法定持股門檻股東，以及因職務可接觸消息的僱員。",
      "只有持牌代表。"
    ],
    2,
    "關連人士範圍不限於執行董事，也可涵蓋具持股關係或因職務取得內幕消息的人士。",
    `${source2023}；Paper 2 第7章`
  ),
  researchQuestion(
    "P2-C7-R045",
    7,
    "避免損失的內幕交易",
    "財務董事利用未公開壞消息沽售股份，交易本身仍錄得小額虧損。沒有獲利是否可排除內幕交易？",
    [
      "可以，只有實際獲利才構成內幕交易。",
      "不可以；利用內幕消息避免更大損失仍可能構成內幕交易。",
      "可以，只要交易者不是持牌人。",
      "可以，只要消息來自債務人而不是上市公司。"
    ],
    1,
    "內幕交易不以最終賺錢為必要條件，利用消息避免損失同樣可能違規。",
    `${source2023}；Paper 2 第7章`
  ),
  researchQuestion(
    "P2-C7-R046",
    7,
    "搶先交易",
    "交易員得知客戶即將落大額買盤，先以自己帳戶買入同一證券，等待客戶盤推高價格。這屬於什麼？",
    [
      "搶先交易（front running）",
      "正常最佳執行",
      "穩定價格安全港",
    ...
    0,
    "搶先交易是利用未執行客戶指令為自己或關連人士先行交易，構成嚴重利益衝突。",
    `${source2006}；Paper 2 第7章`
  ),
  researchQuestion(
    "P2-C7-R047",
    7,
    "市場失當的私人索償",
    "投資者因他人的市場失當蒙受金錢損失，是否一定要等對方刑事定罪後才可尋求民事賠償？",
    [
      "是，沒有刑事定罪便永遠不能索償。",
      "不一定；符合 SFO 法定條件時可提出私人損害賠償申索。",
      "只可向投資者賠償基金索償。",
      "只可要求聯交所退回交易費。"
    ],
    1,
    "市場失當的民事責任與刑事程序並非完全相同；受損人士可按法定條件尋求賠償。",
    `${source2006}；Paper 2 第7章`
  ),
  researchQuestion(
    "P2-C7-R048",
    7,
    "加重紀律制裁因素",
    "相較於沒有損失的輕微技術性違規，哪項因素通常最可能令證監會採取較嚴厲制裁？",
    [
      "違規損害市場廉潔穩健。",
      "中介人沒有從違規獲利。",
      "違規純屬一次輕微疏忽。",
...
function deduplicateQuestions(candidates) {
  const stems = new Set();
  const correctStatements = new Set();

  return candidates.filter((question) => {
    const stem = normalizeQuestionText(question.stem);
    const correct = normalizeQuestionText(question.options[question.answer]);
    if (stems.has(stem) || correctStatements.has(correct)) return false;
    stems.add(stem);
    correctStatements.add(correct);
    return true;
  });
}
